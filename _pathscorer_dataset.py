...
class RelProj:
    ...
    def make_dataset(self, ids, mode, bound):
        ...
        save_dir = "../path_score/data_trainQ"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--id2q_file", type=str, default="train-id2q.pkl")
    ...
    answers = pkl.load(open(os.path.join(args.data_path, "train-answers.pkl"), "rb"))
    queries = pkl.load(open(os.path.join(args.data_path, "train-queries.pkl"), "rb"))
